...
class LiveDataCallAdapterFactory : Factory() {
    ...
    override fun get(returnType: Type, annotations: Array<Annotation>, retrofit: Retrofit): CallAdapter<*, *>? {
        ...
        if (getRawType(returnType) != LiveData::class.java && getRawType(returnType) != MutableLiveData::class.java) {
        ...
        return if (getRawType(returnType) == LiveData::class.java){
            LiveDataCallAdapter<Any>(responseType)
        }else{
            MutableLiveDataCallAdapter<Any>(responseType)
        }
